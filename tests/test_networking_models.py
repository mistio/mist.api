import mist.api.networks.models
import mist.api.clouds.models
...
class MockCloud(mist.api.clouds.models.Cloud):
...
class TestNetworkModels(object):
    ...
    def test_openstack_validation(self):
        ...
        network = \
            mist.api.networks.models.OpenStackNetwork(cloud=self.dummy_cloud)
        network.title = 'test'
...
class TestSubnetModels(object):
    dummy_network = mist.api.networks.models.Network(cloud=MockCloud())
    ...
    def test_cidr_validation(self):
        ...
        subnet = mist.api.networks.models.Subnet(network=self.dummy_network)
        subnet.title = 'test'
    ...
    def test_ec2_availability_zone(self):
        subnet = mist.api.networks.models.AmazonSubnet(
    ...
    def test_gce_name_validation(self):
        subnet = mist.api.networks.models.GoogleSubnet(
            network=self.dummy_network)
        subnet.title = 'test'
        subnet.cidr = '10.1.1.0/24'
