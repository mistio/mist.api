...
def _create_machine_softlayer(conn, key_name, private_key, public_key,
    ...
    try:
        ...
        server_key = conn.import_key_pair_from_string('mistio' + str(random.randint(1, 100000)), key)
        server_key = server_key.extra.get('id')
...
def _create_machine_vultr(conn, public_key, machine_name, image, size, location, cloud_init):
    ...
    ex_create_attr = {}
    if cloud_init:
        ex_create_attr['userdata'] = base64.b64encode(cloud_init)
