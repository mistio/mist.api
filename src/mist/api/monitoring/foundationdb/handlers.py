            ...
            for metric in metrics:
                ...
                try:
                    if data_freq == "s":
                        ...
                        key_timestamp_start = metric_per_minute.pack(
                            tuple_key_start
                        )
                        key_timestamp_stop = metric_per_minute.pack(
                            tuple_key_stop
                        )
                        ...
                        key_timestamp_start = metric_per_hour.pack(
                            tuple_key_start
                        )
                        key_timestamp_stop = metric_per_hour.pack(
                            tuple_key_stop
                        )
