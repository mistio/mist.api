...
ALLOW_SIGNIN_LDAP = True #if LDAP_SETTINGS.get('SERVER', '') else False
...
ALLOW_SIGNIN_LDAP = True if LDAP_SETTINGS['SERVER'] \
    and not LDAP_SETTINGS['AD'] else False
ALLOW_SIGNIN_AD = True if LDAP_SETTINGS['SERVER'] \
    and LDAP_SETTINGS['AD'] else False
